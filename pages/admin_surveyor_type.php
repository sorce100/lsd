...
<div class="row">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             <div class="panel-title pull-left">SURVEYOR TYPE SETUP </div>
                            ...
                            foreach ($types as $type) {
                                    echo "
                                        <tr>
                                          ...
                                          <td>
                                            <button type='button' id='".trim($type["surveyor_id"])."' class='btn btn-info btn-xs update_data'>Update <i class='fa fa-edit'></i></button>
                                          </td>
                                          <td>
                                           <button type='button' id='".trim($type["surveyor_id"])."' class='btn btn-danger btn-xs del_data'>Delete <i class='fa fa-trash'></i></button>
                                          </td>
                                        </tr>
                                      ";
                                }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" id="bg">
        ...
        <h4 class="modal-title"><b id="subject">ADD NEW SURVEYOR TYPE</b></h4>
      </div>
